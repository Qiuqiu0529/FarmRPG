...
public class InventoryItem implements Cloneable {// prototype，代表背包里的物体
    ...
    public boolean usable = true;//可以被使用
    public boolean consumable = true;//可以被消耗,可以被消耗就可以送
    ...
    public float value=0;//价值
    public String description="";//描述

    public int maxStack = 999;// 一格物品最多能叠的数量，在考虑要不要一个格子能放无限多的同类物品orz
    ...
    public Inventory TargetInventory() {
        ...
        _targetInventory = InventoryMgr.GetInstance().FindInventory(targetInventoryName);
    ...
    public Inventory TargetEquipmentInventory() {
        ...
        _targetEquipmentInventory = InventoryMgr.GetInstance().FindInventory(targetEquipmentInventoryName);
